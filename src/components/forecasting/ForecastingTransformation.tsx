...
interface ForecastingTransformationProps {
  historicalData: any[];
  onDataUpdate?: (updatedData: { historicalData: any[] }) => void;
  model: string;
}

export function ForecastingTransformation({ historicalData, onDataUpdate, model }: ForecastingTransformationProps) {
    ...
    <div className="space-y-4 p-4">
      <div className="p-4 bg-muted/50 rounded-lg">
        ...
        <p className="text-xs text-muted-foreground mb-4">
          Modify your forecasting data using natural language or SQL UPDATE syntax
        </p>
        ...
        <div className="space-y-3">
          <Textarea
            ...
            placeholder="Example: Increase all demand by 20% or UPDATE historicalData SET demand = demand * 1.2"
        ...
        <Alert className="border-primary/30 bg-primary/5">
          ...
          <AlertDescription className="mt-2 space-y-3">
            ...
            <div className="bg-background/80 border rounded-lg p-3 text-xs space-y-3">
              <p className="font-semibold text-primary text-sm">📋 Available Table & Columns:</p>
              <div className="border-l-2 border-primary/30 pl-3">
                <p className="font-semibold text-primary mb-1.5">📊 Table Name: <code className="bg-muted px-2 py-0.5 rounded text-xs">historicalData</code></p>
                <ul className="text-muted-foreground space-y-0.5 ml-2 text-[11px]">
                  <li>• <span className="font-medium">date</span> (date) - Data point date</li>
                  <li>• <span className="font-medium">demand</span> (number) - Demand value ✏️</li>
                  <li>• <span className="font-medium">customer</span> (text) - Customer name ✏️</li>
                  <li>• <span className="font-medium">product</span> (text) - Product name ✏️</li>
                </ul>
              </div>
              ...
              <div className="bg-muted/50 rounded p-2">
                ...
                <ul className="text-muted-foreground space-y-0.5 ml-2 font-mono text-[10px]">
                  <li>• UPDATE historicalData SET demand = demand * 1.5</li>
                  <li>• UPDATE historicalData SET demand = 100 WHERE product = 'Product A'</li>
                  <li>• UPDATE historicalData SET customer = 'New Customer'</li>
                </ul>
              </div>
            </div>
