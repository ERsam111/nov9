...
export function GFASidebarNav({ activeTable, onTableSelect, customerCount, demandCount, productCount, existingSiteCount }: GFASidebarNavProps) {
  ...
  const getCounts = (itemId: string) => {
    ...
    if (itemId === "demand") return demandCount;
