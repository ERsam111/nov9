...
import { Save, Trash2, GitCompare, Filter, BarChart3, LineChart } from "lucide-react";
  ...
  return (
    <Card>
      ...
      <CardContent>
        ...
        {/* Charts Section */}
        {!loading && selectedScenarios.size > 0 && scenarios.length > 0 && (
          <div className="mt-8 space-y-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Compare KPIs across scenarios</p>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              {(kpiFilters.totalCost || kpiFilters.transportationCost || kpiFilters.facilityCost) && (
                <Card>
                  <CardHeader>
                    ...
                    <ResponsiveContainer width="100%" height={300}>
                      {chartType === 'bar' ? (
                        <BarChart data={[
                          ...(currentData ? [{
                            name: 'Current',
                            'Total Cost': currentData.totalCost,
                            'Transportation': currentData.transportationCost,
                            'Facility': currentData.facilityCost,
                          }] : []),
                          ...displayedScenarios.map(s => ({
                            name: s.name,
                            'Total Cost': s.totalCost,
                            'Transportation': s.transportationCost,
                            'Facility': s.facilityCost,
                          }))
                        ]}>
                          ...
                          />
                          <Legend />
                          {kpiFilters.totalCost && <Bar dataKey="Total Cost" fill="hsl(var(--primary))" />}
                          {kpiFilters.transportationCost && <Bar dataKey="Transportation" fill="hsl(var(--chart-2))" />}
                          {kpiFilters.facilityCost && <Bar dataKey="Facility" fill="hsl(var(--chart-3))" />}
                        </BarChart>
                      ) : (
                        <RechartsLineChart data={[
                          ...
                          />
                          <Legend />
                          {kpiFilters.totalCost && <Line type="monotone" dataKey="Total Cost" stroke="hsl(var(--primary))" strokeWidth={2} />}
                          {kpiFilters.transportationCost && <Line type="monotone" dataKey="Transportation" stroke="hsl(var(--chart-2))" strokeWidth={2} />}
                          {kpiFilters.facilityCost && <Line type="monotone" dataKey="Facility" stroke="hsl(var(--chart-3))" strokeWidth={2} />}
                        </RechartsLineChart>
                      )}
                    </ResponsiveContainer>
                  </CardContent>
              ...
              {/* Sites & Distance Chart */}
              {(kpiFilters.numSites || kpiFilters.avgDistance) && (
                <Card>
                  <CardHeader>
                    ...
                    <ResponsiveContainer width="100%" height={300}>
                      {chartType === 'bar' ? (
                        <BarChart data={[
                          ...(currentData ? [{
                            name: 'Current',
                            'Number of Sites': currentData.numSites,
                            'Avg Distance (km)': currentData.avgDistance,
                          }] : []),
                          ...displayedScenarios.map(s => ({
                            name: s.name,
                            'Number of Sites': s.numSites,
                            'Avg Distance (km)': s.avgDistance,
                          }))
                        ]}>
                          <CartesianGrid strokeDasharray="3 3" className="stroke-muted" />
                          <XAxis dataKey="name" className="text-xs" />
                          ...
                          <Tooltip 
                            ...
                            formatter={(value: number, name: string) => 
                              name.includes('Distance') ? `${value.toFixed(1)} km` : value
                            }
                          />
                          <Legend />
                          {kpiFilters.numSites && <Bar dataKey="Number of Sites" fill="hsl(var(--chart-1))" />}
                          {kpiFilters.avgDistance && <Bar dataKey="Avg Distance (km)" fill="hsl(var(--chart-4))" />}
                        </BarChart>
                      ) : (
                        <RechartsLineChart data={[
                          ...(currentData ? [{
                          ...
                          />
                          <Legend />
                          {kpiFilters.numSites && <Line type="monotone" dataKey="Number of Sites" stroke="hsl(var(--chart-1))" strokeWidth={2} />}
                          {kpiFilters.avgDistance && <Line type="monotone" dataKey="Avg Distance (km)" stroke="hsl(var(--chart-4))" strokeWidth={2} />}
                        </RechartsLineChart>
                      )}
                    </ResponsiveContainer>
                  </CardContent>
              ...
              {kpiFilters.demandCoverage && (
                <Card>
                  <CardHeader>
                    <CardTitle className="text-base">Demand Coverage</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <ResponsiveContainer width="100%" height={300}>
                      {chartType === 'bar' ? (
                        <BarChart data={[
                          ...(currentData ? [{
                            name: 'Current',
                            'Coverage %': currentData.demandCoverage,
                          }] : []),
                          ...displayedScenarios.map(s => ({
                            name: s.name,
                            'Coverage %': s.demandCoverage,
                          }))
                        ]}>
                          <CartesianGrid strokeDasharray="3 3" className="stroke-muted" />
                          <XAxis dataKey="name" className="text-xs" />
                          ...
                          />
                          <Legend />
                          <Bar dataKey="Coverage %" fill="hsl(var(--chart-5))" />
                        </BarChart>
                      ) : (
                        <RechartsLineChart data={[
                          ...(currentData ? [{
                          ...
                          />
                          <Legend />
                          <Line type="monotone" dataKey="Coverage %" stroke="hsl(var(--chart-5))" strokeWidth={2} />
                        </RechartsLineChart>
                      )}
                    </ResponsiveContainer>
                  </CardContent>
              ...
              {/* Unit Costs Chart */}
              {(kpiFilters.costPerUnit || kpiFilters.costPerCustomer) && (
                <Card>
                  <CardHeader>
                    ...
                    <ResponsiveContainer width="100%" height={300}>
                      {chartType === 'bar' ? (
                        <BarChart data={[
                          ...(currentData ? [{
                            name: 'Current',
                            'Cost per Unit': currentData.costPerUnit,
                            'Cost per Customer': currentData.costPerCustomer,
                          }] : []),
                          ...displayedScenarios.map(s => ({
                            name: s.name,
                            'Cost per Unit': s.costPerUnit,
                            'Cost per Customer': s.costPerCustomer,
                          }))
                        ]}>
                          <CartesianGrid strokeDasharray="3 3" className="stroke-muted" />
                          <XAxis dataKey="name" className="text-xs" />
                          ...
                          />
                          <Legend />
                          {kpiFilters.costPerUnit && <Bar dataKey="Cost per Unit" fill="hsl(var(--chart-1))" />}
                          {kpiFilters.costPerCustomer && <Bar dataKey="Cost per Customer" fill="hsl(var(--chart-2))" />}
                        </BarChart>
                      ) : (
                        <RechartsLineChart data={[
                          ...(currentData ? [{
                          ...
                          />
                          <Legend />
                          {kpiFilters.costPerUnit && <Line type="monotone" dataKey="Cost per Unit" stroke="hsl(var(--chart-1))" strokeWidth={2} />}
                          {kpiFilters.costPerCustomer && <Line type="monotone" dataKey="Cost per Customer" stroke="hsl(var(--chart-2))" strokeWidth={2} />}
                        </RechartsLineChart>
                      )}
                    </ResponsiveContainer>
                  </CardContent>
