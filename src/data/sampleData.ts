...
export const sampleInventoryData = {
  customerData: [
    {
      ...
      "Backorder Time Limit": 7,
      "Backorder Time UOM": "DAY",
      "Allow Partial Fill Orders": "true",
      "Allow Partial Fill Line Items": "true",
      "Allow Direct Ship": "",
      Notes: "Northeast customer",
      "Queue Priority": "",
    },
    {
      "Customer Name": "C002",
      ...
      "Allow Partial Fill Line Items": "true",
      "Allow Direct Ship": "",
      Notes: "Major NYC customer",
      "Queue Priority": "",
    },
    {
      "Customer Name": "C003",
      Status: "Include",
      Address: "300 Hub Blvd",
      City: "Philadelphia",
      Region: "PA",
      "Postal Code": "19101",
      Country: "USA",
      ...
      "Allow Partial Fill Line Items": "true",
      "Allow Direct Ship": "",
      Notes: "Mid-Atlantic customer",
      "Queue Priority": "",
    },
    {
      "Customer Name": "C004",
      Status: "Include",
      Address: "400 Capital Way",
      City: "Washington",
      Region: "DC",
      "Postal Code": "20001",
      Country: "USA",
  ...
  facilityData: [
    {
      ...
      Latitude: 42.3601,
      Longitude: -71.0589,
      "Fixed Startup Cost": 250000,
    },
    {
      "Facility Name": "Plant1",
      Status: "Include",
      Type: "Factory",
      "Facility Status": "Open",
      "Initial State": "Existing",
      ...
      Latitude: 40.7128,
      Longitude: -74.006,
      "Fixed Startup Cost": 500000,
    },
    {
      "Facility Name": "Warehouse1",
      Status: "Include",
      Type: "Warehouse",
      "Facility Status": "Open",
      "Initial State": "Existing",
      ...
      Latitude: 39.9526,
      Longitude: -75.1652,
      "Fixed Startup Cost": 150000,
    },
    {
      "Facility Name": "Supplier1",
      Status: "Include",
      Type: "Supplier",
      "Facility Status": "Open",
      "Initial State": "Existing",
      Organization: "Parts Supplier Inc",
      Address: "999 Supply Chain Ave",
      City: "Baltimore",
      Region: "MD",
      "Postal Code": "21201",
      Country: "USA",
  ...
  productData: [
    ...
    {
      "Product Name": "Processor_Component",
      Status: "Include",
      "Product Type": "Raw Material",
      "Unit Value": 200,
      "Unit Value UOM": "EA",
  ...
  demandData: [
    {
      ...
      "Product Name": "Laptop_X",
      "Source Name": "DC1",
      "Optimization Policy": "Minimize Cost",
      "Optimization Policy Value": 1,
      "Simulation Policy": "By Preference",
      "Simulation Policy Value": 1,
      Status: "Include",
      "Unit Cost": 0.5,
    },
    {
  ...
  billOfMaterialsData: [
    {
      "BOM ID": "BOM_Laptop",
      "End Product": "Laptop_X",
      "End Product Quantity": 1,
      "Raw Materials": "Screen_Component(1), Processor_Component(1)",
    },
    {
      "BOM ID": "BOM_Smartphone",
      "End Product": "Smartphone_Pro",
      "End Product Quantity": 1,
      "Raw Materials": "Screen_Component(1)",
    },
    {
      "BOM ID": "BOM_Tablet",
      "End Product": "Tablet_Ultra",
      "End Product Quantity": 1,
      "Raw Materials": "Screen_Component(1)",
    },
  ],
